...
const { addProductToInventorySchema, updateProductToInventorySchema, getProductInventoryDetailsSchema, deleteProductInventoryDetailsSchema, findProductInInventoryDetailsSchema, deductProductInInventoryDetailsSchema } = require('../schemas/inventory.schemas');
...
router.post('/deduct', schemaValidator(deductProductInInventoryDetailsSchema), routeHandler(InventoryController.deductProductFromInventoryHandler));
